...
public class JDialog_AddCompAcc extends javax.swing.JDialog {
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        if (parentframe.accountType.equals("Ch")) {
            parentframe.getBankingService().createCheckingAccount(parentframe.accountnr, builder);
        } else {
            parentframe.getBankingService().createSavingsAccount(parentframe.accountnr, builder);
        }
